...
print()
print("**当前状态：年轻项目，尚无正式治理结构。**")
print("- vLLM 项目成立于 2023 年，当前由创始团队（UC Berkeley + 初创公司）主导。")
print("- 无基金会、无 TC、无 RFC 流程。")
print("- 发布节奏快（月级），版本演进以迭代速度为核心指标。")
print()
print("**治理空白：**")
print("- 谁是 maintainer？谁定义贡献标准？")
print("- 当项目从'创始团队主导'走向'社区主导'时，制度如何搭建？")

print()
print("### L3 - Community participation")
print()
print(f"**活动指标：** 周均 {avg_weekly:.0f} commits，高速增长阶段。")
print(f"**贡献结构：** 创始团队 + 早期 adopter，企业贡献者正在涌入。")
